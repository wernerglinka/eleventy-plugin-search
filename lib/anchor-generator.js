 ...
 * @param {string} separator - Separator to clean up
 * @returns {string} Processed text
 */
function processNumbers(text, allowNumbers, separator) {
  if (allowNumbers) {
    return text;
  }
  return text
...
export function generateAnchorId(text, options = {}) {
  ...
  anchor = processNumbers(anchor, config.allowNumbers, config.separator);
